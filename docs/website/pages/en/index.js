...
const Features = () => (
  <Block layout="fourColumn">
    {[
      {
        content: ' O Integra foi desenvolvido visando atender demandas do público da FGA - Campus da Universidade de Brasília. Um dos recursos encontrados no Integra é o Rolês! :)',
        title: 'O App Integra',
